...
Based on the results below, the vancouver_trees dataset is a tibble with 70,063 rows and 22 columns. These columns (variables) are of the following types: character, double-precision floating point number & date.
```{r}
...
For this section of my data analysis, I will create a categorical variable (decade) from the existing numerical variable (date_planted).
```{r}
