...
For this exercise, I intend to plot the distribution of the diameter (inches) of trees in Vancouver. I will to create a density plot which has 'Diameter of Tree at Breast Height (in)' on the x-axis and 'Density' on the y-axis. A blue dotted line will be used to the indicate the mean diameter of all trees in Vancouver.
```{r}
vancouver_trees_height_factor %>%
  ggplot(mapping = aes(diameter)) +
  geom_density(alpha=0.09, color="chartreuse4", fill = "chartreuse4") +
  labs(x = "Diameter of Tree at Breast Height (in)", y = "Density") +
  geom_vline(aes(xintercept=mean(diameter)), color="lightslateblue", linetype="dashed", size=0.5)
```
...
```{r}
irrelevant_variables <- c("tree_id","civic_number","assigned","height_range_id","longitude","latitude")
